...
private:
    ...
    /**
     * @brief Display detailed information about a specific best flight option.
     *
     * This function prints detailed information about a selected best flight option,
     * including the total distance, airports involved, and available airlines for each segment.
     * The user is presented with a clear layout of the trip details, and the option to return to the menu.
     *
     * @param trip A pair containing the path of airports and the total distance of the best flight option.
     */
